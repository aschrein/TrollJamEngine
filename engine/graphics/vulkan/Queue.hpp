...
namespace VK
{
	...
	public:
		...
		void submitCommandBuffer( CommandBuffer const &command_buffer , VkSemaphore wait_semaphore = VK_NULL_HANDLE , VkSemaphore signal_semaphore = VK_NULL_HANDLE ) const
		{
		...
		void present( SwapChain const &swap_chain , VkSemaphore wait_semaphore = VK_NULL_HANDLE ) const
		{
